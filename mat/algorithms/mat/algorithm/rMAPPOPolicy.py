...
from mat.algorithms.mat.utils1.util import update_linear_schedule
...
class R_MAPPOPolicy:
    ...
    def act(self, share_obs, obs, rnn_states_actor, masks, available_actions=None, deterministic=False):
        """
