...
from mat.envs.migrate.migrate_env import MigrateEnv
from mat.runner.shared.migrate_runner  import MigrateRunner as Runner
...
def parse_args(args, parser):
    parser.add_argument('--scenario', type=str, default='pre-migrate')
